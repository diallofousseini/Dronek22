...
export default function WelcomePage({ onEnter }: WelcomePageProps) {
  ...
  return (
    <div className="relative w-full h-screen h-dvh overflow-hidden flex flex-col items-center justify-center font-sans bg-[#0f3e28]">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 max-w-5xl w-full h-full h-dvh py-8 sm:py-16">
        
        <div className="flex flex-col items-center justify-center my-auto w-full max-w-2xl space-y-6 sm:space-y-10">
          ...
          >
            ...
            <div className="relative w-full max-w-[240px] sm:max-w-[320px] md:max-w-[380px] h-16 sm:h-24 md:h-32 filter drop-shadow-[0_0_15px_rgba(255,255,255,0.4)]">
               <Image 
